...
**Definition:** Whenever a book's base bookStatus changes (via FR-01 Add, FR-02 Remove, or FR-04 Change Status), service-catalog publishes a `BookStatusChangedEvent` so other services can react.
